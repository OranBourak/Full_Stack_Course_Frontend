...
const SignUpUserPage: FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const onSave = async () => {
    ...
    if (!passwordRegex.test(password)) {
      Alert.alert("Weak Password", "Password must be at least 8 characters long, include an uppercase letter, a lowercase letter, a number, and a special character.");
      return;
    }
    ...
    Alert.alert("Sign Up Successful", "You have successfully signed up. Please login to continue.");
    navigation.navigate('LoginPage');
  };
  ...
  return (
    <View style={styles.container}>
      <View>
        {avatarUri == "" && <Image source={require("../assets/Avatar.jpg")} style={styles.avatar} />}
